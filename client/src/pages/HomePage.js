...
const HomePage = () => {
  ...
  return (
    <OuterLayout title="All Products-Best offers">
      ...
      <div className="bg-body-tertiary z-100 position-sticky top-0">
        <div className="row mt-3">
          ...
          <div className="col-md-9">
            {/* {JSON.stringify(radio,v null, 4)} */}
            <h1 className="text-center">All Products</h1>
            <div className="d-flex flex-wrap z-0 position-relative">
              {products?.map((p) => (
