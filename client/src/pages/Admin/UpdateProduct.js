...
const UpdateProduct = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      switch (true) {
        ...
        // case !photo:
        //   return toast.error("photo is require");
        case !name:
          return toast.error("name is require");
        case !price:
          return toast.error("price is require");
        case !quantity:
          return toast.error("quantity is require");
      }
      ...
      const { data } = axios.put(
        `${window.location.origin}/api/v1/product/update-product/${id}`,
        productData
      );
      if (data?.success) {
  ...
  const handleDelete = async () => {
    try {
      ...
      const { data } = await axios.delete(
        `${window.location.origin}/api/v1/product/delete-product/${id}`
      );
  ...
  return (
    <OuterLayout title="Admin-CreateProducts">
      <div className="row">
